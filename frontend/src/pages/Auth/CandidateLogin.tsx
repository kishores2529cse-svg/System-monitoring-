            ...
            >
              ...
              <div className="rounded-[32px] border border-[#7CFF4D]/30 bg-[#091109]/95 shadow-[0_30px_90px_rgba(0,0,0,0.7)] backdrop-blur-2xl text-slate-100 relative overflow-hidden ring-1 ring-white/10 flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-7 sm:p-8 border-b md:border-b-0 md:border-r border-white/10 relative overflow-hidden">
                  ...
                  <div className="space-y-3 pt-5 mt-4 border-t border-white/10 relative z-10">
                    <div className="relative flex items-center justify-center -mt-8 mb-2">
                    ...
                    <button
                      ...
                      disabled={candidateLoading}
                      className="w-full py-3 rounded-2xl bg-white hover:bg-slate-100 text-slate-800 text-sm font-bold flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer shadow-md disabled:opacity-60"
                    >
